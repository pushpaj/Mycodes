...
import 'package:autowares/videoURL.dart';
...
class CCTVCameras extends StatefulWidget {
  final WebSocketChannel channel;

  CCTVCameras({Key key, @required this.channel}) : super(key: key);

  @override
  _CCTVCamerasState createState() => _CCTVCamerasState();
}

class _CCTVCamerasState extends State<CCTVCameras> {
